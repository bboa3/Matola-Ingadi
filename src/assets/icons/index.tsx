...
export const PhoneIcon: React.FC = () => (
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone-volume" className="svg-inline--fa fa-phone-volume fa-w-12" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
...
export const Play: React.FC = () => (
  <svg width="148" height="169" viewBox="0 0 148 169" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0)">
      <path d="M140.204 70.8683L23.9179 2.17903C14.4696 -3.39929 0 2.01399 0 15.8113V153.157C0 165.535 13.4455 172.994 23.9179 166.789L140.204 98.1327C150.577 92.0263 150.61 76.9747 140.204 70.8683V70.8683Z" fill="#FDB324"/>
    </g>
    <defs>
      <clipPath id="clip0">
